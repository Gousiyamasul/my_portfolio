    ...
    <>
        ...
        <div className="pdata">
          ...
          <div className="pmain">
            ...
            <p>• Developed a full-stack web application that analyzes programming errors and provides solution suggestions. . <br></br><br></br>• Implemented user authentication, API integration, database storage and bug-history tracking using Flask, MySQL and Python. </p>
            ...
            placement features. <br></br><br></br>• Integrated REST APIs using Axios for HTTP requests and dynamic data rendering.<br></br><br></br>• Built an interactive and user-friendly interface using React components and state management. </p>
          </div>
        </div>
    </>
  )
